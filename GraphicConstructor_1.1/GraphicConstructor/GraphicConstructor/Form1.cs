...
namespace GraphicConstructor
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            //DBEG = Convert.ToDouble(p.Evaluate(textBoxDbeg.Text,0), format);
            //DEND = Convert.ToDouble(p.Evaluate(textBoxDend.Text, 0), format);
            //YNULL = Convert.ToDouble(p.Evaluate(textBoxY0.Text, 0), format);
            //EPS_STEP = Convert.ToDouble(p.Evaluate(textBoxEpsStep.Text, 0), format);
        ...
        private void OldFuncToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            button_close_contextmenu.Visible = true;
        ...
        private void listBoxFunc_Click(object sender, EventArgs e)
        {
            ...
            button_close_contextmenu.Visible = false;
        }
        ...
        private void button_close_contextmenu_Click(object sender, EventArgs e)
        {
            listBoxFunc.Visible = false;
            button_close_contextmenu.Visible = false;
        }
