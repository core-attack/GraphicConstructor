...
namespace GraphicConstructor
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            contextMenuStripFunc.Items.Add("abs(sin(x)/x)").Click += new EventHandler(contextMenuStripFunc_Click);
        ...
        void BuildArrDelt(ZedGraphControl zgc)
        {
            ...
            for (int ind = 0; ind < listFirstElem.Count; ind++)
            {
        ...
        {
            if (ZGcontextMenuStrip.Items[4].Text == "Отображать значения точек")
            {
                ZGcontextMenuStrip.Items[4].Text = "Не отображать значения точек";
            ...
            {
                zedGraphControl1.IsShowPointValues = false;
                ZGcontextMenuStrip.Items[4].Text = "Отображать значения точек";
            }
        }
